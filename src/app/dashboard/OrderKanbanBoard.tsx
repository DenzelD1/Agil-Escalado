...
const KANBAN_COLUMNS = [
  ...
  { id: 'verificado', title: 'Verificado', color: 'border-cyan-200 bg-cyan-50/30', headerColor: 'bg-cyan-100/80 text-cyan-800', active: true },
  { id: 'pendiente_preparacion', title: 'Pend. Prep.', color: 'border-fuchsia-200 bg-fuchsia-50/30', headerColor: 'bg-fuchsia-100/80 text-fuchsia-800', active: true },
  { id: 'pagado', title: 'Pagado', color: 'border-brand-teal/30 bg-brand-teal/10', headerColor: 'bg-brand-teal/20 text-brand-teal' },
  { id: 'listo_para_despacho', title: 'Listo Despacho', color: 'border-indigo-200 bg-indigo-50/30', headerColor: 'bg-indigo-100/80 text-indigo-800', active: true },
  { id: 'en_transito', title: 'En Tránsito', color: 'border-amber-200 bg-amber-50/30', headerColor: 'bg-amber-100/80 text-amber-800', active: true },
